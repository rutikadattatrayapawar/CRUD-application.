...
let ProductsController = class ProductsController {
    ...
    updateProduct(productId, productName, productDesc, prodAddedDate) {
        return this.productsService.updateProduct(productId, productName, productDesc, prodAddedDate);
    }
...
__decorate([
    ...
    __param(2, (0, common_1.Body)('addedon')),
...
__decorate([
    ...
    __param(3, (0, common_1.Body)('addedon')),
    __metadata("design:type", Function),
